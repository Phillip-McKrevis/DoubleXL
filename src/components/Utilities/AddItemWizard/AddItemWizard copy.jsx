...
// Check if the form values are empty or invalid
// If so, set the error message and return early
if (
!formValues.name ||
!formValues.screen_id ||
!formValues.ussd_code ||
!formValues.parentMenuItem
) {
...
// If the form values are present, set the error message and return early
if (isPresent) {
setError("The form values already exist in the values array");
return;
}

// Otherwise, clear the error message and proceed with the rest of the logic
setError("");
